package com.spotify.akka.exercise4.actor;
...
import com.spotify.akka.exercise4.message.Output;
import com.spotify.akka.exercise4.actor.Worker;
	...
	public void onReceive(Object o) throws Exception {
		...
		*/
		if(o instanceof Input) {
			...
			System.out.println("Master Input: " + duration); //print the time required to complete this operation
		}
		...
		*/
			...
			long endTime = System.nanoTime();
			long duration = (endTime - startTime);
			System.out.println("Master Output: " + duration); // print the time required to complete this operation
		}
